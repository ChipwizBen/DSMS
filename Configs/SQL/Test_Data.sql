...
INSERT INTO `user_groups` VALUES (1,'DatabaseAdministrators',0,'0000-00-00',1,'2014-10-09 03:42:19','Ben Schofield'),(2,'UnixAdministrators',0,'0000-00-00',1,'2014-10-09 03:42:45','Ben Schofield');
...
INSERT INTO `distribution` VALUES (1,'transport','/root/.ssh/id_rsa',15,'sudoers/sudoers','OK: sudoers/sudoers written successfully to wlgprdapp01 (127.0.0.1). Sudoers MD5: dc17025ea8b7d7a32e9f7cfb45ce537d\n','2014-10-09 17:45:02','2014-10-09 16:53:31','Ben Schofield'),(2,'transport','/root/.ssh/id_rsa',15,'sudoers/sudoers','OK: sudoers/sudoers written successfully to wlgprdapp02 (127.0.0.2). Sudoers MD5: dc17025ea8b7d7a32e9f7cfb45ce537d\n','2014-10-09 17:45:02','2014-10-09 16:35:15','Ben Schofield'),(3,'transport','/root/.ssh/id_rsa',15,'sudoers/sudoers','OK: sudoers/sudoers written successfully to wlgprdapp03 (127.0.0.3). Sudoers MD5: dc17025ea8b7d7a32e9f7cfb45ce537d\n','2014-10-09 17:45:02','2014-10-09 16:35:25','Ben Schofield'),(4,'transport','/root/.ssh/id_rsa',15,'sudoers/sudoers','Connection Failed: Connection to remote server is broken \n    Hints: \n    1) Badly formatted IP address\n    2) Identity file not found\n    3) Not enough permissions to read identity file','2014-10-09 17:45:02','2014-10-09 16:35:44','Ben Schofield'),(5,'transport','/root/.ssh/id_rsa',15,'sudoers/sudoers','OK: sudoers/sudoers written successfully to wlgprddb01 (127.0.1.1). Sudoers MD5: dc17025ea8b7d7a32e9f7cfb45ce537d\n','2014-10-09 17:45:03','2014-10-09 16:36:15','Ben Schofield'),(6,'transport','/root/.ssh/id_rsa',15,'bla/sudoers','Push Failed: Couldn\'t open remote file \'bla/sudoers(3649).tmp\': No such file \n	Hints: \n    1) Check that the remote path is correct\n    2) If the Remote Server uses chroot, try making the path relative (i.e. path/sudoers instead of /path/sudoers)','2014-10-09 17:45:03','2014-10-09 17:24:56','Ben Schofield'),(7,'transport','/root/.ssh/id_rsa',15,'sudoers/sudoers','OK: sudoers/sudoers written successfully to wlgprddb03 (127.0.1.3). Sudoers MD5: dc17025ea8b7d7a32e9f7cfb45ce537d\n','2014-10-09 17:45:03','2014-10-09 16:36:38','Ben Schofield'),(8,'transport','/root/.ssh/id_rsa',15,'sudoers/sudoers','OK: sudoers/sudoers written successfully to wlgprddb04 (127.0.1.4). Sudoers MD5: dc17025ea8b7d7a32e9f7cfb45ce537d\n','2014-10-09 17:45:03','2014-10-09 16:36:49','Ben Schofield');
...
-- Dump completed on 2014-10-09 17:45:59
